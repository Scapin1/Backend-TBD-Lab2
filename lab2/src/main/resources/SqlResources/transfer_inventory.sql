...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE id_productin = p_id_product
            ...
            AND stock_inventory >= p_amount_product
    ) THEN
...
UPDATE Inventory
SET stock_inventory = stock_inventory - p_amount_product
...
VALUES (p_id_product, p_id_store_destiny, p_amount_product)
    ON CONFLICT (id_productin, id_storein)
    DO UPDATE SET stock_inventory = Inventory.stock_inventory + p_amount_product;

-- Step 3: Record the transaction
INSERT INTO Transactions (type_transaction, id_storeOR, id_storeDE, id_product, amount_product, date_transaction)
VALUES ('Transfer', p_id_store_origin, p_id_store_destiny, p_id_product, p_amount_product, CURRENT_DATE);
END;
$$;